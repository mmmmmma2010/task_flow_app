"""
Django settings for task_flow_app project.
...
DATABASES = {
    'default': {
        ...
        'USER': config('DB_USER', default='taskflow_user'),
        'PASSWORD': config('DB_PASSWORD', default='taskflow_pass'),
...
CELERY_BEAT_SCHEDULE = {
    'cleanup-old-completed-tasks': {
        'task': 'tasks.tasks.cleanup_old_completed_tasks',
